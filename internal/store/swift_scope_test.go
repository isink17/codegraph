...
func TestSwiftClassSelfInheritedFinalMethodScopeMixedStress(t *testing.T) {
	...
	if resolved != 600 || unresolved != 1700 {
		t.Fatalf("state=(resolved %d,unresolved %d), want (600,1700)", resolved, unresolved)
	}
