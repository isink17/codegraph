...
var (
	...
	swiftClassSelfTypeRepair = resolverRepair{
		key:              swiftClassSelfTypeRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfFinalMethodRepair = resolverRepair{
		key:              swiftClassSelfFinalMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfStaticMethodRepair = resolverRepair{
		key:              swiftClassSelfStaticMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfFinalClassMethodRepair = resolverRepair{
		key:              swiftClassSelfFinalClassMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfTypeStaticMethodRepair = resolverRepair{
		key:              swiftClassSelfTypeStaticMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfTypeFinalClassMethodRepair = resolverRepair{
		key:              swiftClassSelfTypeFinalClassMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfInheritedFinalMethodRepair = resolverRepair{
		key:              swiftClassSelfInheritedFinalMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfMultilevelInheritedFinalMethodRepair = resolverRepair{
		key:              swiftClassSelfMultilevelInheritedFinalMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfTypeInheritedStaticMethodRepair = resolverRepair{
		key:              swiftClassSelfTypeInheritedStaticMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfTypeInheritedFinalClassMethodRepair = resolverRepair{
		key:              swiftClassSelfTypeInheritedFinalClassMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	swiftClassSelfTypeMultilevelInheritedStaticMethodRepair = resolverRepair{
		key:              swiftClassSelfTypeMultilevelInheritedStaticMethodRepairSettingKey,
		run:              (*Store).repairSwiftSelfBindings,
		resolvesRepoWide: true,
	}
	...
	swiftInitializerRepair = resolverRepair{
		key:              swiftInitializerRepairSettingKey,
	...
	swiftSuperRepair = resolverRepair{
		key:              swiftSuperRepairSettingKey,
		run:              (*Store).redecideSwiftSuperBindings,
		applies:          (*Store).swiftSuperRepairApplies,
		resolvesRepoWide: true,
	}
	swiftSuperMultilevelInheritedMethodRepair = resolverRepair{
		key:              swiftSuperMultilevelInheritedMethodRepairSettingKey,
		run:              (*Store).redecideSwiftSuperBindings,
		applies:          (*Store).swiftSuperRepairApplies,
		resolvesRepoWide: true,
	}
	swiftSuperTypeMethodRepair = resolverRepair{
		key:              swiftSuperTypeMethodRepairSettingKey,
		run:              (*Store).redecideSwiftSuperBindings,
		applies:          (*Store).swiftSuperRepairApplies,
		resolvesRepoWide: true,
	}
	swiftSuperExtensionMethodRepair = resolverRepair{
		key:              swiftSuperExtensionMethodRepairSettingKey,
		run:              (*Store).redecideSwiftSuperBindings,
		applies:          (*Store).swiftSuperRepairApplies,
		resolvesRepoWide: true,
	}
	swiftSuperExtensionTargetMethodRepair = resolverRepair{
		key:              swiftSuperExtensionTargetMethodRepairSettingKey,
		run:              (*Store).redecideSwiftSuperBindings,
		applies:          (*Store).swiftSuperRepairApplies,
		resolvesRepoWide: true,
	}
