...
var toolRegistry = []toolDescriptor{
	...
	{
		name: "find_symbol", description: "Find symbols by exact or fuzzy query",
	...
	{
		name: "find_callers", description: "Find callers of a symbol",
	...
	{
		name: "find_callees", description: "Find callees of a symbol",
		properties: []string{"symbol", "symbol_id", "limit", "offset", "detail", "format"},
		category:   "graph", gatewayCore: true,
	...
	{
		name: "find_related_tests", description: "Find likely related tests for a symbol, file, or set of changed files",
